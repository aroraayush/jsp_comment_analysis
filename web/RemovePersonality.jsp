...
<body>
<form id="form4" name="form4" method="post" action="RemovePersonality_code.jsp">
        ...
        <tr>
            ...
            <td width="788" align="center" valign="top" bgcolor="#FFFFFF"><p>&nbsp;</p>
                <table width="641" border="11" align="center" cellpadding="4" cellspacing="5">
                    <tr>
                        <td colspan="2" align="center"><h1>Remove Personality Details</h1></td>
                    </tr>
                    <tr>
                        <td width="210">Enter Personality Name</td>
