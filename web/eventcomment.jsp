...
<body>
<form id="form1" name="form1" method="post" action="eventcomment_code.jsp">
...
//session.setAttribute("commdtp","Narendra Modi");
                    ...
                    <%
                        String query = "select * from event where eventname='" + commdt + "'";
     ...
     <span class="textareaRequiredMsg">A value is required.</span></span></td>
            ...
            <td width="193" valign="top">
                <table width="206" border="1" align="center" cellspacing="8">
                    <%
                        String sts = null;
                        String query1 = "SELECT SUM(positivecomment) AS p , SUM(negativecomment) AS n  FROM event where eventname='" + commdt + "';";
