    ...
    <table width="70%" border="1" align="center" cellpadding="5" cellspacing="5">
        ...
        <tr>
            <td width="996" valign="top"><p>&nbsp;</p>
                <table width="813" rules="none" border="1" align="center" cellpadding="5" cellspacing="5">
                    <tr>
                        <td width="415"><h2>Personality Details</h2></td>
                        <td width="382"><h2>Comment Details</h2></td>
                    </tr>
