...
<body>
<form id="form1" name="form1" method="post" action="Personalitycomment_code.jsp">
    <table width="992" border="1" align="center" cellpadding="5" cellspacing="5">
        ...
        <tr>
            <td align="center" valign="top">Latest Description</td>
            <td valign="top">&nbsp;</td>
        </tr>
        <tr>
...
//session.setAttribute("commdtp","Narendra Modi");
                    ...
                    <%
                        String query = "select * from personality where Personalityname='" + commdt + "'";
     ...
     <span class="textareaRequiredMsg">A value is required.</span></span></td>
            ...
            <td width="193" valign="top">
                <table width="206" border="1" align="center" cellspacing="8">
                    <%
                        String sts = null;
                        String query1 = "SELECT SUM(positivecomment) AS p , SUM(negativecomment) AS n  FROM personality where Personalityname='" + commdt + "';";
